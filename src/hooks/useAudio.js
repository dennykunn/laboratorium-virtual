...
const OPERATOR_AUDIO_MAP = {
  ...
  "slide-gerak-merumuskan-hipotesis": `${operatorPerbaikan}/008.mp3`,
  ...
  "slide-gaya-merumuskan-hipotesis": `${operatorPerbaikan}/008.mp3`,
...
export const initSounds = () => {
  createAudioContext();
  // Pre-load wav files
  ["/assets/backsound/Benar.wav", "/assets/backsound/Salah.wav", "/assets/backsound/Mulai Quiz.wav", "/assets/backsound/Tampilan Nilai.wav"].forEach((src) => {
    audioCache[src] = new Audio(src);
  });
};
